    ...
    fn default() -> Self {
        Self {
            ...
            database: DatabaseConfig {
                url: "postgres://localhost/nornen".to_string(),
                max_connections: 10,
                min_connections: 2,
            },
...
pub struct SettingsManager {
    settings: Arc<RwLock<NornenSettings>>,
    config_path: PathBuf,
}
...
impl SettingsManager {
    pub fn new(config_path: PathBuf) -> Self {
        Self {
            settings: Arc::new(RwLock::new(NornenSettings::default())),
            config_path,
        }
    }
    ...
    pub async fn load(&self) -> Result<(), SettingsError> {
        if !self.config_path.exists() {
            ...
            let default_settings = NornenSettings::default();
        ...
        let settings: NornenSettings = serde_json::from_str(&content)?;
    ...
    pub async fn get(&self) -> NornenSettings {
    ...
    pub fn validate(&self, settings: &NornenSettings) -> Result<(), SettingsError> {
                    ...
                    if matches!(event.kind, EventKind::Modify(_)) {
                        ...
                        if path == config_path {
                            ...
                            if let Err(e) = rt.block_on(async {
                                ...
                                let new_settings: NornenSettings = serde_json::from_str(&content)?;
