# AGENTS.md - Hirtir Development Guidelines
...
**Performance from the Start**: Hirtir must handle high data volumes efficiently.
...
- See `hirtir/README.md` for detailed service documentation
