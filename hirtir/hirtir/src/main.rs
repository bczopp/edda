...
use hirtir::utils::config::SettingsManager;
use hirtir::coordinator::ServiceCoordinator;
use hirtir::grpc::{start_grpc_server, GrpcServerDependencies};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    info!("Hirtir Provider Service starting...");

    // Load configuration
    let config_path = PathBuf::from("config/hirtir.json");
