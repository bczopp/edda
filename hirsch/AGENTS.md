# AGENTS.md - Die vier Hirsche Development Guidelines
...
**Performance from the Start**: Die vier Hirsche must handle high data volumes efficiently.
...
- See `hirsch/README.md` for detailed service documentation
